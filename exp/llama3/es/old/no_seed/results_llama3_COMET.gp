...
set key noopaque
unset label
set label 1 "COMET" at 7.25000, 0.933500, 0.00000 left norotate font "Helvetica, 14" back nopoint
set label 2 "Rank" at 256.000, 0.92550, 0.00000 right norotate font "Helvetica, 14" back nopoint
unset arrow
unset style line
unset style arrow
...
plot '/tmp/r0' u 1:4 t 'a = r/2' w lp, '/tmp/r1' u 1:4 t 'a = r' w lp, '/tmp/r2' u 1:4 t 'a = 2*r' w lp
#    EOF
