...
set output 'results_llama3_COMET.pdf'
unset clip points
set clip one
unset clip two
unset clip radial
...
set key noopaque
unset label
set label 1 "COMET" at 7.25000, 0.931500, 0.00000 left norotate font "Helvetica, 14" back nopoint
set label 2 "Rank" at 120.000, 0.920500, 0.00000 right norotate font "Helvetica, 14" back nopoint
unset arrow
unset style line
unset style arrow
