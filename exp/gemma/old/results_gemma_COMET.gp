...
set output 'results_gemma_COMET.pdf'
unset clip points
set clip one
unset clip two
unset clip radial
...
set key notitle
set key fixed center bottom vertical Right noreverse enhanced autotitle nobox
set key noinvert samplen 4 spacing 1 width 0 height 0
set key maxcolumns 0 maxrows 0
set key noopaque
unset label
set label 1 "COMET" at 7.25000, 0.90500, 0.00000 left norotate font "Helvetica, 14" back nopoint
set label 2 "Rank" at 120.000, 0.83300, 0.00000 right norotate font "Helvetica, 14" back nopoint
unset arrow
unset style line
unset style arrow
...
!cat results_gemma.csv | sed 's/,/ /g' | tail -n +2 | split -l 5 - /tmp/
plot '/tmp/aa' u 2:4 t 'a = 32' w lp, '/tmp/ab' u 2:4 t 'a = 64' w lp, '/tmp/ac' u 2:4 t 'a=128' w lp
#    EOF
