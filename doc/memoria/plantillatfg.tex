...
%Los tipos de arquitectura más comunes de las redes neuronales son el perceptrón multicapa (MLP), redes neuronales convolucionales (CNN)o redes neuronales recurrentes (RNN).
