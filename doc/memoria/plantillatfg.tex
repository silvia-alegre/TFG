...
Las redes neuronales modernas están compuestas por pequeñas unidades de cómputo, cada una de las cuales toma un vector de entrada y produce un único valor de salida. Comparten muchas de las matemáticas utilizadas en la regresión logística, pero son clasificadores mucho más potentes.

\subsection{Funcionamiento de las redes neuronales}
