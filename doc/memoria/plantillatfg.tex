...
La siguiente tabla muestra la cantidad de datos utilizados para los experimentos en español y en inglés:
...
Para evaluar se utilizarán las métricas de BLEU y COMET
...
[Formato de las prompts]
[Explicación proceso (cross validation con n = ?, lora y parámetros utilizados)]
