...
En esta sección, se realiza un análisis de los errores más comunes observados en la generación de frases por parte de los modelos. Este análisis tiene como objetivo identificar y comprender los problemas recurrentes en las salidas generadas, proporcionando así una base para futuras mejoras en este.

De las 50 frases del conjunto de validación, 18 fueron generadas exactamente iguales a las frases reales. De las 27 frases con errores, hay 9 cuyo único error está en el tiempo verbal de la frase:

\begin{itemize}
	\item no, lo, cambiar. Frase real: No lo cambiaré. Frase generada: No lo cambio
	\item niños, se, reír. Frase real: Los niños se reían. Frase generada: Los niños se ríen.
\end{itemize}


Entre las frases que contienen errores, estos se dividen en los siguientes tipos:

\begin{itemize}
	\item Errores en los tiempos verbales
		\subitem [no, lo, cambiar]. Frase real: No lo cambiaré. Frase generada: No lo cambio. 
		\subitem [niños, se, reír]. Frase real: Los niños se reían. Frase generada: Los niños se ríen.
	\item Fallos de conjugación
	\item Falta de alguna preposición o conjunción
	\item Confusión en el sujeto
\end{itemize}
