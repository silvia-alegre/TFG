...
Para los experimentos de este trabajo, se utilizarán y compararán tres modelos \textit{open-source} preentrenados: Gemma, Llama-3 y GPT-4. Estos modelos serán explicados con detalle en las siguientes secciones.
...
\begin{itemize}
	...
	\item \textbf{\textit{RMSNorm}} \cite{zhang2019rootmeansquarelayer}: se normaliza la entrada a cada una de las capas con RMSNorm para estabilizar el entrenamiento. Este tipo de normalización es más eficiente que la de la arquitectura de transformers original.
\end{itemize}
