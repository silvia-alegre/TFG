...
Los modelos de lenguaje grandes necesitan hacen uso de una gran cantidad de recursos computacionales.

La cuantización mapea de un valor de alta precisión a niveles discretos para un mejor soporte del hardware y eficiencia.

\cite{xiao2024smoothquantaccurateefficientposttraining}

\section{Modelos utilizados} \label{modelosUtilizados}

\subsubsection{GPT-4}

El modelo GPT-4 \cite{openai2024gpt4technicalreport} es el último de los modelos GPT, desarrollados por \textit{OpenAI}. Estos son modelos de lenguaje grandes que utilizan la arquitectura de transformer y que están diseñados para predecir la siguiente palabra en una secuencia.
