...
Algunos de los comunicadores que existen actualmente en el mercado ya emplean diferentes métodos para abordar este problema, pero existe todavía un amplio margen de mejora. Las recientes innoviaciones en el campo de la inteligencia artificial y el procsamiento de lenguaje natural prometen ofrecer buenos resultados en esta área. Es por esto, que en este trabajo se estudiará la aplicabilidad de los modelos de lenguaje grandes a este tipo de herramientas.
...
COMET (\textit{Crosslingual Optimized Metric for Evaluation of Translation}) \cite{rei2020cometneuralframeworkmt}
